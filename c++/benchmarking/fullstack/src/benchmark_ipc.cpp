        ...
        size_t blob_size)
    {
        ...
        auto transport = rpc::ipc_spsc_transport::make_client(
            ...
            rpc::ipc_spsc_transport::options{
                ...
                .dll_path = {},
                .dll_zone = child_zone,
                .process_kind = rpc::ipc_spsc_transport::child_process_kind::direct_service,
        ...
        result.error = CO_AWAIT run_benchmark_calls(remote_processor, payload, durations_ns, ipc_warmup_calls);
        if (result.error == rpc::error::OK())

...
// Use the build-agnostic rpc::coro::scheduler spelling provided by
// <rpc/rpc.h>, as demo_zone does.
...
namespace websocket_demo
{
    namespace v1
    {
        // Video effect bitmask (matches i_calculator::set_video_effects).
        // Browser toggles these live.
        ...
        class video_session
        {
            struct pump : std::enable_shared_from_this<pump>
            {
                ...
                // Latches if codec init persistently fails. Without this,
                // every inbound frame retries init, pegging the CPU and
                // flooding the log.

...
//
// In coroutine builds this is an alias of libcoro's coro::net::io_status. In
// blocking builds it is a parallel POD with the same kind enum and accessors so
// streaming code can be written once against rpc::io_status and compile in both
// modes.

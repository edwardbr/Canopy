...
namespace canopy::security::attestation
{
    ...
    {
        // This is the per-domain-service route gate. A web-facing service can
    ...
    // One policy object should be associated with each domain_service instance.
    // The attestation_service remains domain-wide and cryptographic; this

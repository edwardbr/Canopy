...
// streaming::blocking::tcp::acceptor — TCP listener that produces streaming::stream
...
// rpc::tcp_blocking_stream::endpoint so callers don't reference libcoro types directly.
...
{
    using endpoint = ::rpc::tcp_blocking_stream::endpoint;

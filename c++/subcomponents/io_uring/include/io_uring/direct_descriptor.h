...
namespace rpc::io_uring
{
    ...
    public:
        ...
        // Owns one kernel fixed-file-table slot allocated by the io_uring
        // instance. The value is not a process fd; it must be used with SQEs
        // carrying IOSQE_FIXED_FILE/direct-descriptor semantics.
        direct_descriptor(

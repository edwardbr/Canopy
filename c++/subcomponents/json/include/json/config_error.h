...
namespace json
{
    inline namespace v1
    {
        ...
        // the rest of <json/config.h>'s configuration-loading surface. The
        // SGX libcxx subset is missing some of those, so keeping this header
        // minimal lets convert.h compile under FOR_SGX.

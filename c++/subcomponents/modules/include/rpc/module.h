...
namespace rpc::module
{
    ...
    // whether the containing binary is a blocking DLL, coroutine DLL, SGX
    // enclave, or another module runtime. The runtime-specific
    ...
    // runtime boundaries such as shared objects, C ABI modules, and enclaves
    ...
    // such as blocking_dll and SGX blocking. The wrapper converts
    ...
    // rather than a child_service. This is used by shared-scheduler and SGX
    // coroutine-style registration paths where the transport setup already
    // controls the service lifetime.
    template<
        class Remote,
        class Local>

...
// Test DLL entry point for the blocking_dll transport tests.
//
// This shared object is loaded by blocking_dll_transport_setup via dlopen.
...
{
    return rpc::blocking_dll::init_child_zone<yyy::i_host, yyy::i_example>(
        params,

...
extern std::string coroutine_enclave_path;          // NOLINT(cppcoreguidelines-avoid-non-const-global-variables)
extern std::string sgx_coroutine_test_enclave_path; // NOLINT(cppcoreguidelines-avoid-non-const-global-variables)
#else                                               // Linux
extern std::string enclave_path;                    // NOLINT(cppcoreguidelines-avoid-non-const-global-variables)
extern std::string coroutine_enclave_path;          // NOLINT(cppcoreguidelines-avoid-non-const-global-variables)
extern std::string sgx_coroutine_test_enclave_path; // NOLINT(cppcoreguidelines-avoid-non-const-global-variables)

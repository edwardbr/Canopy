...
protected:
    ...
    {
        rpc::zone dll_zone;
        std::shared_ptr<rpc::ipc_spsc::transport> transport;
    ...
    std::shared_ptr<rpc::ipc_spsc::transport> client_transport_;
    ...
    connect_child(
        ...
        rpc::shared_ptr<yyy::i_example>& example)
    {
        transport = rpc::ipc_spsc::make_client(
            child_name,
            this->root_service_,
...
public:
    ...
    void pump_until_disconnected(
        const std::shared_ptr<rpc::ipc_spsc::transport>& t,

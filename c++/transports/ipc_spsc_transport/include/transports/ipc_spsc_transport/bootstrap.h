...
namespace rpc::ipc_spsc_transport
{
    ...
    public:
        ...
        [[nodiscard]] rpc::ipc_spsc_transport::queue_pair* map_queue_pair() const;
        static void unmap_queue_pair(rpc::ipc_spsc_transport::queue_pair* queues);
    };

    class sidecar_bootstrap : public queue_pair_bootstrap
    {
    ...
    public:
        ...
        [[nodiscard]] static std::shared_ptr<sidecar_bootstrap> from_command_line(
            int argc,
            char** argv);
    ...
    using child_host_bootstrap = sidecar_bootstrap;

    class child_process_bootstrap : public queue_pair_bootstrap
    {
    public:
        child_process_bootstrap(
            std::string mapped_file,
            rpc::zone child_zone,
            size_t scheduler_thread_count);
        ...
        [[nodiscard]] static std::shared_ptr<child_process_bootstrap> from_command_line(
            int argc,
            char** argv);
        [[nodiscard]] std::vector<std::string> make_command_line() const;
    };

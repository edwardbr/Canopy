...
#  if defined(_WIN32)
#    if defined(CANOPY_IPC_SPSC_DLL_BUILDING)
#      define CANOPY_IPC_SPSC_DLL_EXPORT __declspec(dllexport)
#    else
#      define CANOPY_IPC_SPSC_DLL_EXPORT __declspec(dllimport)
#    endif
#  else
#    define CANOPY_IPC_SPSC_DLL_EXPORT __attribute__((visibility("default")))
#  endif

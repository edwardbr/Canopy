...
#  endif
        ...
        std::shared_ptr<rpc::service> service)
    {
        ...
        auto transport_name = rpc::transport_creation::configured_name(settings.name, "ipc_spsc_transport");
        ...
        rpc::ipc_spsc_transport::options options;
        ...
        auto transport = rpc::ipc_spsc_transport::make_client(transport_name, resolved_service, std::move(options));
        return {rpc::error::OK(), std::move(resolved_service), std::move(transport), std::move(proxy_name)};
    }
} // namespace rpc::ipc_spsc_transport

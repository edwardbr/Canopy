...
// DLL-side libcoro_host_scheduled_dynamic_library transport.  Coroutine-build only.
//
// This header is included by shared objects that participate in the
// Canopy libcoro_host_scheduled_dynamic_library transport.  It provides:
//
...
//
// Usage pattern (DLL author — canopy_libcoro_host_scheduled_dll_init.cpp):
//
...
#  include <rpc/rpc.h>
#  include <transports/libcoro_host_scheduled_dynamic_library/dll_abi.h>

namespace rpc::libcoro_host_scheduled_dynamic_library
{
    // Concrete init coroutine supplied by the shared object that links this
    // transport library. canopy_libcoro_host_scheduled_dll_create is provided by the
    ...
    // pointers captured during canopy_libcoro_host_scheduled_dll_create.
    // -------------------------------------------------------------------------
    ...
    public:
        ...
        // ------------------------------------------------------------------
        static coro::task<send_result> static_inbound_send(
            void* ctx,
            send_params params)
        {
        ...
        static coro::task<void> static_inbound_post(
            void* ctx,
            post_params params)
        {
        ...
        static coro::task<standard_result> static_inbound_try_cast(
            void* ctx,
        ...
        static coro::task<standard_result> static_inbound_add_ref(
            void* ctx,
        ...
        static coro::task<standard_result> static_inbound_release(
            void* ctx,
        ...
        static coro::task<void> static_inbound_object_released(
            void* ctx,
        ...
        static coro::task<void> static_inbound_transport_down(
            void* ctx,

...
//
// Compiled into transport_libcoro_host_scheduled_dynamic_library_dll, which the DLL links.
// The DLL author only needs to provide canopy_libcoro_host_scheduled_dll_init.
...
extern "C" CANOPY_LIBCORO_HOST_SCHEDULED_DLL_EXPORT void canopy_libcoro_host_scheduled_dll_create(
    rpc::libcoro_host_scheduled_dynamic_library::dll_create_params* params,
    rpc::libcoro_host_scheduled_dynamic_library::dll_create_result* result)
{
    using namespace rpc::libcoro_host_scheduled_dynamic_library;
    ...
    result->init_fn = &canopy_libcoro_host_scheduled_dll_init;

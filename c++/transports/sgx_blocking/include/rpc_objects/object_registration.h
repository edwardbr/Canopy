...
#include <transports/sgx_blocking/object_registration.h>

// Transport-selected object-module adapter.
//
// A blocking SGX object module defines canopy_module_init() and calls
...
// factory with the SGX blocking runtime.

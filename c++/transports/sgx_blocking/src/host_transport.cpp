...
#  endif
        ...
        json::v1::object& runtime_startup_settings_storage() noexcept
        {
            static json::v1::object settings{json::v1::map{}};
            return settings;
        }
    }
    ...
    {
        return runtime_startup_settings_storage();
    }

    void set_runtime_startup_settings(json::v1::object settings)
    {
        runtime_startup_settings_storage() = std::move(settings);
    }

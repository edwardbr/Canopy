...
#include <transports/shared_scheduler_dll/object_registration.h>

// Transport-selected object-module adapter.
//
// A shared-scheduler DLL module defines canopy_module_init() and calls
// rpc::register_object<Remote, Local>(). This header maps that uniform module
// hook onto the shared-scheduler DLL coroutine ABI.
...
namespace rpc::shared_scheduler_dll
{
    ...
    {
        rpc::object_module_init_params params{transport_ctx, settings, scheduler, {}, false};

...
// Host-side shared_scheduler_dll transport.  Coroutine-build only.
//
...
// (canopy_shared_scheduler_dll_create) via dlsym, calls it synchronously to obtain the
...
namespace rpc::shared_scheduler_dll
{
    class child_transport : public rpc::transport
    {
        ...
        // These are passed as host_coro_*_fn callbacks to canopy_shared_scheduler_dll_create.
        ...
        // Load the shared object and resolve canopy_shared_scheduler_dll_create
        int load_library();

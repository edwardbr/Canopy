...
extern "C" CANOPY_SHARED_SCHEDULER_DLL_EXPORT void canopy_shared_scheduler_dll_create(
    rpc::shared_scheduler_dll::dll_create_params* params,
    rpc::shared_scheduler_dll::dll_create_result* result)
{
    using namespace rpc::shared_scheduler_dll;
    ...
    result->init_fn = &canopy_shared_scheduler_dll_init;

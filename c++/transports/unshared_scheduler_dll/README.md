...
- `transport_unshared_scheduler_dll`
...
## Difference from `shared_scheduler_dll`

`shared_scheduler_dll` passes the host scheduler into the DLL
...
The `unshared_scheduler_dll_lifecycle.dll_static_state_resets_after_transport_unload`

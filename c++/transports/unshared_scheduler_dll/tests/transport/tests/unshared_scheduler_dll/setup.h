...
#  ifndef CANOPY_TEST_UNSHARED_SCHEDULER_DLL_PATH
#    error "CANOPY_TEST_UNSHARED_SCHEDULER_DLL_PATH must be defined (set by CMake)"
#  endif

template<bool UseHostInChild, bool RunStandardTests, bool CreateNewZoneThenCreateSubordinatedZone>
class unshared_scheduler_dll_setup
...
public:
    ~unshared_scheduler_dll_setup() override = default;
    ...
    CORO_TASK(bool) CoroSetUp()
    {
        ...
        auto child_transport = std::make_shared<rpc::unshared_scheduler_dll::child_transport>(
            "main child", this->root_service_, CANOPY_TEST_UNSHARED_SCHEDULER_DLL_PATH);
    ...
    CORO_TASK(rpc::shared_ptr<yyy::i_example>) create_new_zone()
    {
        ...
        auto child_transport = std::make_shared<rpc::unshared_scheduler_dll::child_transport>(
            "new child", this->root_service_, CANOPY_TEST_UNSHARED_SCHEDULER_DLL_PATH);

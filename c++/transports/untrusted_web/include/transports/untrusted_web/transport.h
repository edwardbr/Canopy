...
#include <untrusted_web/config.h>
#include <websocket/websocket_protocol.h>

namespace rpc::untrusted_web
{
    // Browser-facing RPC transport for web clients. The underlying stream may
    // be WebSocket/TLS/TCP, but callers should treat the peer as untrusted.

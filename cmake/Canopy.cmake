...
if(NOT DEPENDENCIES_LOADED)
  ...
  set(CANOPY_HARDWARE_ATTESTATION_BACKENDS SGX_EPID DCAP)
  list(FIND CANOPY_HARDWARE_ATTESTATION_BACKENDS "${CANOPY_ATTESTATION_BACKEND}"
       CANOPY_HARDWARE_ATTESTATION_BACKEND_INDEX)
  if(CANOPY_HARDWARE_ATTESTATION_BACKEND_INDEX EQUAL -1)
    set(CANOPY_ATTESTATION_BACKEND_IS_HARDWARE OFF)
  else()
    set(CANOPY_ATTESTATION_BACKEND_IS_HARDWARE ON)
  endif()
  ...
  if(CANOPY_PRODUCTION_RELEASE)
    ...
    if(CANOPY_BUILD_ENCLAVE AND CANOPY_SGX_BACKEND STREQUAL "Fake")
      message(
        FATAL_ERROR "CANOPY_PRODUCTION_RELEASE=ON rejects CANOPY_SGX_BACKEND=Fake. "
    ...
    if(CANOPY_BUILD_ENCLAVE AND NOT "${SGX_MODE}" STREQUAL "release")
      message(FATAL_ERROR "CANOPY_PRODUCTION_RELEASE=ON requires SGX_MODE=release for enclave builds.")
    endif()
  endif()
  ...
  set(CANOPY_BUILD_SGX_ATTESTATION_TESTS OFF)
  if(CANOPY_BUILD_TEST

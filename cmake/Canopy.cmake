...
macro(canopy_add_subdirectory_without_clang_tidy source_dir)
  set(_canopy_saved_enable_clang_tidy "${CANOPY_ENABLE_CLANG_TIDY}")
  set(_canopy_saved_clang_tidy_command "${CLANG_TIDY_COMMAND}")
  set(_canopy_saved_cxx_clang_tidy "${CMAKE_CXX_CLANG_TIDY}")
  set(CANOPY_ENABLE_CLANG_TIDY OFF)
  set(CLANG_TIDY_COMMAND)
  set(CMAKE_CXX_CLANG_TIDY)
  add_subdirectory("${source_dir}" ${ARGN})
  set(CMAKE_CXX_CLANG_TIDY "${_canopy_saved_cxx_clang_tidy}")
  set(CLANG_TIDY_COMMAND "${_canopy_saved_clang_tidy_command}")
  set(CANOPY_ENABLE_CLANG_TIDY "${_canopy_saved_enable_clang_tidy}")
endmacro()
...
if(NOT DEPENDENCIES_LOADED)
  ...
  message("CANOPY_BUILD_ZSTD ${CANOPY_BUILD_ZSTD}")
  message("CANOPY_BUILD_ZLIB ${CANOPY_BUILD_ZLIB}")
  ...
  if(GIT_FOUND)
    ...
    if(GIT_SUBMODULE)
      ...
      message(STATUS "CANOPY_BUILD_ZSTD: ${CANOPY_BUILD_ZSTD}")
      message(STATUS "CANOPY_BUILD_ZLIB: ${CANOPY_BUILD_ZLIB}")

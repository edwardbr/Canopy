...
if(NOT DEPENDENCIES_LOADED)
  ...
  set_property(CACHE CANOPY_ATTESTATION_BACKEND PROPERTY STRINGS "FAKE" "NULL" "SGX_SIM" "SGX_EPID")
  if(NOT CANOPY_ATTESTATION_BACKEND MATCHES "^(FAKE|NULL|SGX_SIM|SGX_EPID)$")
    message(
      FATAL_ERROR
        "Invalid CANOPY_ATTESTATION_BACKEND '${CANOPY_ATTESTATION_BACKEND}', expected FAKE, NULL, SGX_SIM, or SGX_EPID")
  endif()

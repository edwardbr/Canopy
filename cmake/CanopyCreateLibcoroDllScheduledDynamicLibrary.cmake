...
function(CanopyCreateLibcoroDllScheduledDynamicLibrary target_name)
  set(options)
  set(oneValueArgs)
  ...
  if(NOT CANOPY_PLUGIN_SOURCES)
    message(FATAL_ERROR "CanopyCreateLibcoroDllScheduledDynamicLibrary(${target_name}) requires SOURCES")
  endif()

  add_library(${target_name} SHARED ${CANOPY_PLUGIN_SOURCES})

  target_compile_definitions(${target_name} PRIVATE ${CANOPY_DEFINES} CANOPY_LIBCORO_DLL_SCHEDULED_DLL_BUILDING

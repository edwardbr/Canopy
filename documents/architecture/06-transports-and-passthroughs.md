...
| [IPC Transport](../transports/spsc_and_ipc.md) | Process-owned child zone connections over SPSC streams | Coroutines |
| [TCP](../transports/tcp.md) | Network communication between machines | Coroutine scheduler or blocking executor |
| [io_uring](../transports/io_uring.md) | Linux loopback stream factories | Coroutines |

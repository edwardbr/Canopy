...
| `nanopb` | Nanopb C runtime plus Canopy C++ adapters | SGX enclaves and small-runtime builds |
...
- Nanopb-generated `.pb.c` files with enclave flags,
- Canopy-generated Nanopb C++ adapter code with enclave flags.

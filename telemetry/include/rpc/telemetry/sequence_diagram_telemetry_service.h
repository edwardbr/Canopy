...
namespace rpc
{
    ...
    public:
        ...
        void on_service_proxy_try_cast(
            ...
            rpc::caller_zone caller_zone_id,
            rpc::interface_ordinal interface_id) const override;
        void on_service_proxy_add_ref(
            rpc::zone zone_id,
            rpc::remote_object remote_object_id,
            rpc::caller_zone caller_zone_id,
            rpc::requesting_zone requesting_zone_id,
            rpc::add_ref_options options) const override;
        void on_service_proxy_release(
            rpc::zone zone_id,
            rpc::remote_object remote_object_id,
            rpc::caller_zone caller_zone_id,
            rpc::release_options options) const override;
        ...
        void on_impl_creation(
            const std::string& name,
            uint64_t address,
            rpc::zone zone_id) const override;
        void on_impl_deletion(
            uint64_t address,
            rpc::zone zone_id) const override;

        void on_stub_creation(
            rpc::zone zone_id,
            rpc::object object_id,
            uint64_t address) const override;
        void on_stub_deletion(
            rpc::zone zone_id,
        ...
        void on_stub_add_ref(
            rpc::zone zone_id,
            rpc::object object_id,
            rpc::interface_ordinal interface_id,
            uint64_t count,
            rpc::caller_zone caller_zone_id) const override;
        void on_stub_release(
            rpc::zone zone_id,
            rpc::object object_id,
            rpc::interface_ordinal interface_id,
            uint64_t count,
        ...
        void on_interface_proxy_creation(
            const std::string& name,
            rpc::zone zone_id,
            rpc::destination_zone destination_zone_id,
            rpc::object object_id,
            rpc::interface_ordinal interface_id) const override;
        void on_interface_proxy_deletion(
            rpc::zone zone_id,
            rpc::destination_zone destination_zone_id,
            rpc::object object_id,
            rpc::interface_ordinal interface_id) const override;
        void on_interface_proxy_send(
        ...
        void on_transport_deletion(
            rpc::zone zone_id,
            rpc::zone adjacent_zone_id) const override;
        void on_transport_status_change(
            const std::string& name,
            rpc::zone zone_id,
            rpc::zone adjacent_zone_id,
        ...
        void on_transport_remove_destination(
            ...
            rpc::destination_zone destination,
            rpc::caller_zone caller) const override;
        void on_transport_accept(
            rpc::zone zone_id,
            rpc::zone adjacent_zone_id,
            int result) const override;

        // Pass-through events
        void on_pass_through_creation(
            rpc::zone zone_id,
        ...
        void on_pass_through_release(
            rpc::zone zone_id,
            rpc::destination_zone forward_destination,
            rpc::destination_zone reverse_destination,
            int64_t shared_delta,
            int64_t optimistic_delta) const override;
        void on_pass_through_status_change(
            rpc::zone zone_id,
            rpc::destination_zone forward_destination,
            rpc::destination_zone reverse_destination,
        ...
        void on_transport_outbound_send(
            zone zone_id,
            ...
            interface_ordinal interface_id,
            method method_id) const override;
        void on_transport_outbound_post(
            zone zone_id,
            zone adjacent_zone_id,
            remote_object remote_object_id,
            caller_zone caller_zone_id,
            interface_ordinal interface_id,
            method method_id) const override;
        void on_transport_outbound_try_cast(
            zone zone_id,
            zone adjacent_zone_id,
            remote_object remote_object_id,
            caller_zone caller_zone_id,
            interface_ordinal interface_id) const override;
        void on_transport_outbound_add_ref(
            zone zone_id,
            zone adjacent_zone_id,
            remote_object remote_object_id,
            caller_zone caller_zone_id,
        ...
        void on_transport_outbound_release(
            zone zone_id,
            zone adjacent_zone_id,
            remote_object remote_object_id,
            caller_zone caller_zone_id,
        ...
        void on_transport_outbound_object_released(
            ...
            remote_object remote_object_id,
            caller_zone caller_zone_id) const override;
        void on_transport_outbound_transport_down(
            zone zone_id,
            zone adjacent_zone_id,
            destination_zone destination_zone_id,
            caller_zone caller_zone_id) const override;
        ...
        void on_transport_inbound_send(
            zone zone_id,
            zone adjacent_zone_id,
            remote_object remote_object_id,
            caller_zone caller_zone_id,
            interface_ordinal interface_id,
            method method_id) const override;
        void on_transport_inbound_post(
            zone zone_id,
            zone adjacent_zone_id,
            remote_object remote_object_id,
            caller_zone caller_zone_id,
            interface_ordinal interface_id,
            method method_id) const override;
        void on_transport_inbound_try_cast(
            zone zone_id,
            zone adjacent_zone_id,
            remote_object remote_object_id,
            caller_zone caller_zone_id,
            interface_ordinal interface_id) const override;
        void on_transport_inbound_add_ref(
            zone zone_id,
            zone adjacent_zone_id,
            remote_object remote_object_id,
            caller_zone caller_zone_id,
            requesting_zone requesting_zone_id,
            add_ref_options options) const override;
        void on_transport_inbound_release(
            zone zone_id,
            zone adjacent_zone_id,
            remote_object remote_object_id,
            caller_zone caller_zone_id,
        ...
        void on_transport_inbound_object_released(
            ...
            remote_object remote_object_id,
            caller_zone caller_zone_id) const override;
        void on_transport_inbound_transport_down(
            zone zone_id,
            zone adjacent_zone_id,
            destination_zone destination_zone_id,
            caller_zone caller_zone_id) const override;

...
#  endif
    ...
    {
        RPC_INFO("[libcoro_ipc_dynamic_dll] parent expired callback received");
        {
...
#  endif
    ...
    void loaded_library::stop()
    {
        ...
        {
            RPC_INFO("[libcoro_ipc_dynamic_dll] stopping runtime");
        ...
        if (lib_handle_)
        {
            RPC_INFO("[libcoro_ipc_dynamic_dll] unloading library");
#  if defined(_WIN32)

    ...
    CORO_TASK(bool) CoroSetUp()
    {
        ...
        service_ = std::make_shared<rpc::root_service>("test_service",
            rpc::zone{rpc::zone_address(rpc::zone_address::construction_args(rpc::zone_address::version_3, rpc::zone_address::address_type::local, 0, {},
                rpc::zone_address::default_local_subnet_size_bits, 1, rpc::zone_address::get_default_local_object_id_size_bits(), 0, {}))},
            io_scheduler_);
#else
        service_ = std::make_shared<rpc::root_service>("test_service",
            rpc::zone{rpc::zone_address(rpc::zone_address::construction_args(rpc::zone_address::version_3, rpc::zone_address::address_type::local, 0, {},
        ...
        forward_dest_ = rpc::destination_zone{rpc::zone_address(rpc::zone_address::construction_args(rpc::zone_address::version_3,
            rpc::zone_address::address_type::local, 0, {}, rpc::zone_address::default_local_subnet_size_bits, 100,
            rpc::zone_address::get_default_local_object_id_size_bits(), 0, {}))};
        reverse_dest_ = rpc::destination_zone{rpc::zone_address(rpc::zone_address::construction_args(rpc::zone_address::version_3,
            rpc::zone_address::address_type::local, 0, {}, rpc::zone_address::default_local_subnet_size_bits, 200,
            rpc::zone_address::get_default_local_object_id_size_bits(), 0, {}))};
